...
public class ArithmeticExpression extends Expression {
    ...
    public ArithmeticExpression(ParseTreeNode n, TypeName t, String wantedSigns, List<String> operations) {
        super(t);
        for(int i = 0; i < wantedSigns.length(); i++) {
            operationsMap.put(String.valueOf(wantedSigns.charAt(i)), operations.get(i));
        }
    ...
    public void process() {
        ...
        for(int i = 0; i < signs.size(); i++) {
            ...
            String currentOperation = operationsMap.get(String.valueOf(signs.get(i)));
